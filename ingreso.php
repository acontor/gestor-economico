...
<head>
  ...
  <title>Gestor de gastos - Nuevo ingreso</title>
            ...
            <div class="container-fluid">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-warning">Datos del ingreso</h6>
                </div>
                <div class="card-body">
                  <div class="container">
                    <div class="card-body">
                      <form action="utils/insertar.php" method="POST">
                        <input type="text" class="d-none" name="tipo" value="Ingresos">
                        <div class="form-row">
